...
/*uint8 DIO_u8SetPinDirection(uint8 Copy_u8Port,uint8 Copy_u8PinNum,uint8 Copy_u8Direction)
{
	...
	uint8 Local_u8ErrorState = OK;
		...
		if((Copy_u8PinNum <= DIO_u8_PIN7) && (Copy_u8Direction<=DIO_u8_PIN_OUTPUT))
		{
			...
			case DIO_u8_PORTA:	ASSIGN_BIT(DDRA,Copy_u8PinNum,Copy_u8Direction); break;
			case DIO_u8_PORTB:	ASSIGN_BIT(DDRB,Copy_u8PinNum,Copy_u8Direction); break;
			case DIO_u8_PORTC:	ASSIGN_BIT(DDRC,Copy_u8PinNum,Copy_u8Direction); break;
			case DIO_u8_PORTD:	ASSIGN_BIT(DDRD,Copy_u8PinNum,Copy_u8Direction); break;
			default: Local_u8ErrorState = NOK; break;
			}
		}
		else
